...
from utils.utils import load_demo_configs
from estimator.common import Face
from estimator.common import Visualizer
from estimator.gaze_estimator import GazeEstimator
...
class Demo:
    ...
    def _wait_key(self) -> None:
        key = cv2.waitKey(self.config['demo']['wait_time']) & 0xffb
